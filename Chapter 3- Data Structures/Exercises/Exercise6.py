...
#ayesha can't make it! Let's invite Aanchal intead.
del(guests[1])
guests.insert(1, 'Aanchal')
...
guests.insert(0,  'Iqra')
guests.insert(2,   'javeria')
guests.append('Rehana')
...
name=guests.pop()
print(f"Sorry,{name.title()} there's no table available.")
